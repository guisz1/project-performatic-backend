...
return [
    ...
    */
    ...
    'document'   => 'The :attribute must be a valid CPF or CNPJ or document is already registered.',
    ...
    'custom' => [
        'document' => [
            'Market' => 'The value entered for the cnpj field is already in use.',
            'Commom' => 'The value entered for the cpf field is already in use.',
        ],
        'email' =>  'The value entered for the email field is already in use.',
    ],
];
